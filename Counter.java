...
public class Counter extends Actor
{
    ...
    private void updateImage()
    {
        ...
        GreenfootImage text = new GreenfootImage(prefix + value, 44, Color.BLACK, transparent); // was 22 font size
        
        if (text.getWidth() > image.getWidth() - 40) // was 20
        {
            image.scale(text.getWidth() + 40, image.getHeight()+10);
        }
